...
class ImageCategorizationService:
    def __init__(self):
        ...
        self.non_design_terms = [
            ...
            "horse", "cow", "chicken", "lion", "tiger", "elephant", "jellyfish",
            "aquarium", "underwater", "marine", "coral", "reef", "dolphin", "whale",
            "insect", "spider", "bee", "butterfly", "zoo",
            # Sports & Activities
            ...
            "sunset", "sunrise", "weather", "rain", "snow", "rock", "cliff",
            "canyon", "valley", "waterfall", "lake", "pond", "field", "meadow",
            "safari", "savanna", "tundra", "arctic", "glacier", "volcano",
            # Infrastructure (non-interior)
            "highway", "road", "street", "bridge", "tunnel", "railway", "railroad",
            "airport runway", "aerial view", "aerial photo", "satellite", "drone shot",
            "cityscape", "skyline", "aerial", "birds eye", "intersection", "freeway",
            # Products (non-furniture)
            "electronics", "gadget", "mobile", "phone", "computer", "laptop",
            "tablet", "camera", "watch", "jewelry", "accessory", "coffee cup", "mug",
            # Fashion
            ...
            "graffiti", "street art", "mural", "random", "misc", "miscellaneous",
            # Body parts
            "hand", "hands", "feet", "leg", "arm", "finger",
            # Other non-design
            "palm tree", "beach resort", "tropical", "travel", "tourism", "vacation",
            "landmark", "monument", "statue", "cave", "ruins"
        ]
